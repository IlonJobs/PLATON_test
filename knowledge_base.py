...
class KnowledgeBase:
    ...
    def get_answer(self, query: str, user_id: int, chat_history: List[Dict]):
        ...
        prompt = f"""
        Ты помощник. Отвечай на вопрос, используя контекст и историю. Если в контексте и истории ответа не найдено, тогда
        ничего не придумывай. Отвечай: "в базе знаний ответа на заданный вопрос не найдено"
